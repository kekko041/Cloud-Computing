...
> **Attenzione**: D.Lgs. 33/2013 e D.Lgs. 150/2009 sono normativa primaria **generale**, non emanata da AGID — AGID ne è un soggetto attuatore (come ogni PA) e fornisce un buon caso di studio applicativo, ma per il testo normativo pieno va integrata la consultazione con `fonti_banca_italia/`.
